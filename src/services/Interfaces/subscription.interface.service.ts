...
export interface ISubscriptionService {
    ...
    updatePlan(id: string, data: Partial<ISubscriptionPlan>): Promise<ISubscriptionPlan>;
    ...
    cancelUserSubscription(id: string, reason?: string): Promise<IUserSubscription>;

    // User-facing
    getMySubscription(userId: string | Types.ObjectId): Promise<IUserSubscription | null>;
